...
in
{
  ...
  config = (
    lib.mkIf
      (cfg.desktop.wayland.enable && builtins.elem "hyprland" cfg.desktop.wayland.selectedSessions)
      {
        home-manager.sharedModules = [
          (
            ...
            in
            {
              home.sessionVariables = lib.mkIf debug { ASAN_OPTIONS = "log_path=/tmp/asan.log"; };
              home.packages =
                with pkgs;
                [
                  hyprpaper
