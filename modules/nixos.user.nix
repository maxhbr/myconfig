      ...
      extraUsers = {
        "${myconfig.user}" = {
          ...
          openssh.authorizedKeys.keys = [
            ...
            "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIID3sMl+Ocl3tlNEZuRQJCSxQ1MvhzMl/b0m3wdOirwT"
            "ssh-rsa "
          ];
        };
        root = {
          openssh.authorizedKeys.keys =
