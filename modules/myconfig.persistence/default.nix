      ...
      (
        { config, ... }:
        {
          ...
          config = {
            ...
            myconfig.persistence.directories = nixosConfig.myconfig.persistence.directories;
            myconfig.persistence.files = nixosConfig.myconfig.persistence.files;
            myconfig.persistence.work-directories = nixosConfig.myconfig.persistence.work-directories;
