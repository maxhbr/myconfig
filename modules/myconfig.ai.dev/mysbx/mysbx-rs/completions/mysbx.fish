...
complete -c mysbx -n '__mysbx_no_verb' -l backend -x -a 'bubblewrap podman-gvisor nono' -d 'The backend of THIS run (overrides the config layers for one run)'
...
complete -c mysbx -n '__mysbx_in_run' -l backend -x -a 'bubblewrap podman-gvisor nono' -d 'The backend of THIS run (overrides the config layers for one run)'
