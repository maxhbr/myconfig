...
#
# myconfig.ai.dev.microvm — Cloud Hypervisor agent-sandbox tier.
#
# A second, stronger isolation tier for autonomous coding agents, alongside
# the existing QEMU/SLiRP `modules/myconfig.ai.dev/sandboxes/myconfig.ai.qemu-agent-sandbox/builders.nix` tier. It runs each agent
...
let
  ...
  agentRegistry = import ./agents.nix {
    ...
    # `myconfig.ai.dev.hermes` backends use (a LiteLLM route). Reading the option
    # (not `cfg`) keeps ONE model definition for host and sandbox alike.
    hermesModel = config.myconfig.ai.dev.hermes.model.default;
  };
...
in
{
  ...
  options.myconfig.ai.dev.microvm = with lib; {
    enable = mkEnableOption "myconfig.ai.dev.microvm (Cloud Hypervisor agent sandboxes)";
      ...
      assertions = [
        {
          ...
          message = "myconfig.ai.dev.microvm.guestAgentUid/guestAgentGid must be unprivileged (> 0).";
        }
        {
          assertion = slots != [ ];
          message = "myconfig.ai.dev.microvm: the resource-class pool is empty (no class with count > 0).";
        }
        {
          assertion = lib.length slots <= slotLib.maxSlotCount;
          message = "myconfig.ai.dev.microvm: the total number of slots (${toString (lib.length slots)}) must be <= ${toString slotLib.maxSlotCount} (deterministic MAC/IPv4 generator bound).";
        }
        {
          ...
          message = "myconfig.ai.dev.microvm.resourceClasses: class names must match [a-z][a-z0-9-]*.";
        }
        {
          ...
          message = "myconfig.ai.dev.microvm.resourceClasses: class names are too long — generated TAP names must be <= ${toString slotLib.maxInterfaceNameLength} chars (got ${
        ...
        }
        {
          ...
          message = "myconfig.ai.dev.microvm: generated slot names are not unique.";
        }
        {
          assertion = lib.length (lib.unique slotTaps) == lib.length slotTaps;
          message = "myconfig.ai.dev.microvm: generated slot TAP names are not unique.";
        }
        {
          assertion = isAbsolutePath cfg.workspaceRoot;
          message = "myconfig.ai.dev.microvm.workspaceRoot must be an absolute path.";
        }
        {
          assertion = isAbsolutePath cfg.runtimeRoot;
          message = "myconfig.ai.dev.microvm.runtimeRoot must be an absolute path.";
        }
        {
          assertion = isAbsolutePath cfg.stateRoot;
          message = "myconfig.ai.dev.microvm.stateRoot must be an absolute path.";
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.stateRoot ("${cfg.stateRoot}") must equal
        ...
        }
        {
          ...
          message = "myconfig.ai.dev.microvm.bridgeName must be non-empty.";
        }
        {
          assertion = cfg.gatewayAddress != "";
          message = "myconfig.ai.dev.microvm.gatewayAddress must be non-empty.";
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm: an SSH control channel (enableSsh = true or the
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm: the `vsock` capability is only allowed with the
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.litellmPort must not be ${toString reservedNotifyVsockPort} on a host
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm: the `vsock` capability requires
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.capabilities: unknown capability ${
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.capabilities selects no capability, so the guest
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.capabilities selects no WORKLOAD capability
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.enableSsh = true has no meaning without the
            ...
            "interactive" to `myconfig.ai.dev.microvm.capabilities`
            (currently: ${lib.concatStringsSep ", " agentCapabilities.selected}) or set
            `myconfig.ai.dev.microvm.enableSsh = false`.
          '';
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm: networkProfile = "${effectiveProfile}" is an
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm: networkProfile = "package-access" requires
        ...
        }
        {
          ...
          message = "myconfig.ai.dev.microvm.packageProxyPort must differ from litellmPort.";
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm: the effective network profile
        ...
        }
        {
          ...
          message = "myconfig.ai.dev.microvm: generated slot IPv4 addresses are not unique.";
        }
        {
          assertion = lib.length (lib.unique slotMACs) == lib.length slotMACs;
          message = "myconfig.ai.dev.microvm: generated slot MAC addresses are not unique.";
        }
        {
          assertion = lib.length (lib.unique slotCIDs) == lib.length slotCIDs;
          message = "myconfig.ai.dev.microvm: generated slot VSOCK CIDs are not unique.";
        }
        {
          ...
          message = "myconfig.ai.dev.microvm: generated slot VSOCK CIDs must avoid the reserved values 0/1/2 and VMADDR_CID_ANY.";
        }
        {
          assertion = effectiveRegistry.declaredNames != [ ];
          message = "myconfig.ai.dev.microvm: the agent registry (agents.nix) must declare at least one agent.";
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.enabledAgents: unknown agent(s) ${lib.concatStringsSep ", " effectiveRegistry.unknownEnabled}.
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.enabledAgents selects no agent, so the guest
        ...
        }
        {
          ...
          message = ''
            myconfig.ai.dev.microvm.enabledAgents selects no agent that can run
            ...
            "batch" from `myconfig.ai.dev.microvm.capabilities`.
          '';
        }
      ]
