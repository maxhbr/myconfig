...
Note that parts of this repository under [[./vendor/]] are vendored from
upstream projects and remain licensed under their respective licenses
(see the =LICENSE= file inside each vendored directory). For example,
[[./vendor/alexdavid-jail.nix/]] is licensed under GPL-3.0.
