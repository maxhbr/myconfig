...
(defconst thrift-font-lock-keywords
  (list
   ...
   '("\\<\\(include\\|struct\\|union\\|namespace\\|exception\\|typedef\\|php_namespace\\|const\\|enum\\|service\\|extends\\|void\\|async\\|throws\\|optional\\|required\\|oneway\\)\\>" . font-lock-keyword-face)  ;; keywords
