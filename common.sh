...
NIX_PATH="nixpkgs=$nixpkgs:nixpkgs-overlays=$overlaysDir:myconfig=$myconfigDir"
NIX_PATH_ARGS="-I nixpkgs=$nixpkgs -I nixpkgs-overlays=$overlaysDir -I myconfig=$myconfigDir"
export NIX_PATH
